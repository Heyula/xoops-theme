<div class="xoops-comment-template" id="comment<{$comment.id}>">
    <div class="row hidden-xs">
        <div class="col-xs-2 col-md-2 rhiza"><{$comment.poster.uname}></div><!-- .col-md-3 -->
    ...
    <div class="row">
        ...
        <div class="col-xs-3 col-md-3 xoops-comment-author aligncenter">
            <{if $comment.poster.id != 0}>
                <img src="<{$xoops_upload_url}>/<{$comment.poster.avatar}>" class="img-thumbnail rhiza" alt="">	
		...
		<!-- .col-md-3 .xoops-comment-author -->

        <div class="col-xs-9 col-md-9 xoops-comment-text">
